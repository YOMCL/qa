#!/bin/bash
# QA Caren Staging APP — 2 reintentos automáticos + intervención manual en el 3ro

export JAVA_HOME="/Applications/Android Studio.app/Contents/jbr/Contents/Home"
export PATH="$JAVA_HOME/bin:$PATH"
export PATH="$HOME/Library/Android/sdk/platform-tools:$PATH"

ENV_FILE="tests/app/config/config.caren.yaml"
SESSION="tests/app/flows/caren-session.yaml"
...
echo -e "${YELLOW}=== QA Caren STAGING APP — $(date '+%Y-%m-%d %H:%M') ===${NC}"
echo ""
...
echo -e "${RED}✗ Falló intento 1 — reintentando...${NC}"
echo ""
